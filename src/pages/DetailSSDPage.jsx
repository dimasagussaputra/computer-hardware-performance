...
export default function DetailSSDPage({ onNavigate, data }) {
  if (!data) {
    return (
      <div style={{
        minHeight: "100vh",
        ...
        <div style={{ textAlign: "center" }}>
          <p style={{ fontSize: "1.5rem", marginBottom: "1rem" }}>SSD data not found</p>
          <button
            onClick={() => onNavigate('best-ssd')}
            style={{
              background: "#3b82f6",
              color: "white",
              padding: "0.8rem 2rem",
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "3rem" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "3rem", flexWrap: "wrap" }}>
            <img
              src={data.img || "https://via.placeholder.com/200x200/0066ff/ffffff?text=SSD"}
              alt={data.model}
              style={{
                width: "200px",
                height: "200px",
              ...
              onError={(e) => { e.target.src = "https://via.placeholder.com/200x200/0066ff/ffffff?text=SSD"; }}
            />
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              {data.detail || "No specification details available for this SSD."}
            </p>
          </div>
        </div>
